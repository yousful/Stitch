...
const Explore = () => {
  return (
    <main className="mt-[1rem] flex  gap-y-4 flex-col-reverse md:flex-row justify-between ">
      <div className=" w-full md:w-1/2 ">
        <h2 className="font-playfair text-[40px] leading-[60px] font-medium text-black mb-[1rem]">
          {" "}
          About
        </h2>
