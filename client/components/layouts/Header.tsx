    ...
    <nav className='w-full h-[84px] bg-accent flex justify-center items-center'>
      <section className='max-w-[1440px] w-full flex justify-between items-center'>
        ...
        <div className='flex gap-2 items-center'>
          ...
          <Button className='bg-primary text-accent rounded-3xl font-secondaryExraBold font-semibold leading-[24px]'>
            Register
          </Button>
          <Button className='bg-accent text-primary rounded-3xl border-primary border font-secondaryExraBold font-semibold leading-[24px]'>
            Login
          </Button>
        </div>
      </section>
