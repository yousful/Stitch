...
function Header() {
  return (
    <nav className="w-full bg-[white]  flex justify-center z-[2500px] items-center sticky top-0">
      <section className="mx-16 my-6 w-full flex justify-between items-center">
        <Image
          priority
          width={140}
          height={140}
        ...
        />
        <div className="flex gap-x-12 items-center font-medium font-secondaryNormal ">
